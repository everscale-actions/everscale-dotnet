...
namespace ch1seL.TonNet.Abstract.Modules
{
    public interface IProcessingModule : ITonModule
    {
        ...
        /// </summary>
        public Task<ResultOfSendMessage> SendMessage(ParamsOfSendMessage @params, Action<ProcessingEvent, uint> callback = null,
        ...
        /// </summary>
        public Task<ResultOfProcessMessage> WaitForTransaction(ParamsOfWaitForTransaction @params, Action<ProcessingEvent, uint> callback = null,
            CancellationToken cancellationToken = default);
        ...
        /// </summary>
        public Task<ResultOfProcessMessage> ProcessMessage(ParamsOfProcessMessage @params, Action<ProcessingEvent, uint> request = null,
            CancellationToken cancellationToken = default);
    }
}