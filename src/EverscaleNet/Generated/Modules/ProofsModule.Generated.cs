...
namespace EverscaleNet.Client.Modules
{
    ...
    public class ProofsModule : IProofsModule
    {
        ...
        {
            await _everClientAdapter.Request<ParamsOfProofBlockData>("proofs.proof_block_data", @params, cancellationToken);
        }
        ...
        {
            await _everClientAdapter.Request<ParamsOfProofTransactionData>("proofs.proof_transaction_data", @params, cancellationToken);
        }
        ...
        {
            await _everClientAdapter.Request<ParamsOfProofMessageData>("proofs.proof_message_data", @params, cancellationToken);
        }
    }
}