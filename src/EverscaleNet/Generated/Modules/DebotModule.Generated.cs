...
namespace EverscaleNet.Client.Modules
{
    ...
    public class DebotModule : IDebotModule
    {
        ...
        /// </summary>
        public async Task<RegisteredDebot> Init(ParamsOfInit @params, Func<JsonElement, uint, CancellationToken, Task> appObject = null, CancellationToken cancellationToken = default)
        {
