...
namespace EverscaleNet.Client.Modules
{
    ...
    public class NetModule : INetModule
    {
        ...
        {
            return await _everClientAdapter.Request<ParamsOfQuery, ResultOfQuery>("net.query", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfBatchQuery, ResultOfBatchQuery>("net.batch_query", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfQueryCollection, ResultOfQueryCollection>("net.query_collection", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfAggregateCollection, ResultOfAggregateCollection>("net.aggregate_collection", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfWaitForCollection, ResultOfWaitForCollection>("net.wait_for_collection", @params, cancellationToken);
        }
        ...
        {
            await _everClientAdapter.Request<ResultOfSubscribeCollection>("net.unsubscribe", @params, cancellationToken);
        }
        ...
        /// </summary>
        public async Task<ResultOfSubscribeCollection> SubscribeCollection(ParamsOfSubscribeCollection @params, Func<JsonElement, uint, CancellationToken, Task> callback = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <para>refresh all cached (or visible to user) lists where this sequences presents.</para>
        /// </summary>
        public async Task<ResultOfSubscribeCollection> Subscribe(ParamsOfSubscribe @params, Func<JsonElement, uint, CancellationToken, Task> callback = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            await _everClientAdapter.Request("net.suspend", cancellationToken);
        }
        ...
        {
            await _everClientAdapter.Request("net.resume", cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfFindLastShardBlock, ResultOfFindLastShardBlock>("net.find_last_shard_block", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<EndpointsSet>("net.fetch_endpoints", cancellationToken);
        }
        ...
        {
            await _everClientAdapter.Request<EndpointsSet>("net.set_endpoints", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ResultOfGetEndpoints>("net.get_endpoints", cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfQueryCounterparties, ResultOfQueryCollection>("net.query_counterparties", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfQueryTransactionTree, ResultOfQueryTransactionTree>("net.query_transaction_tree", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfCreateBlockIterator, RegisteredIterator>("net.create_block_iterator", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfResumeBlockIterator, RegisteredIterator>("net.resume_block_iterator", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfCreateTransactionIterator, RegisteredIterator>("net.create_transaction_iterator", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfResumeTransactionIterator, RegisteredIterator>("net.resume_transaction_iterator", @params, cancellationToken);
        }
        ...
        {
            return await _everClientAdapter.Request<ParamsOfIteratorNext, ResultOfIteratorNext>("net.iterator_next", @params, cancellationToken);
        }
