...
using ch1seL.TonNet.Client.Tests.Modules.DebotModule;
using Xunit;
...
namespace ch1seL.TonNet.Client.Tests.Modules
{
    ...
    {
        private readonly DebotTestBrowser _debotTestBrowser;
        ...
        {
            (var initDebotData, DebotTestBrowser debotTestBrowser) = fixture.Init(outputHelper, true);
