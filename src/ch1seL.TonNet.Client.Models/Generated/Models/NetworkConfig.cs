...
namespace ch1seL.TonNet.Client.Models
{
    ...
    public class NetworkConfig
    {
        ...
        /// <summary>
        ///     <para>
        ///         The number of automatic message processing retries that SDK performs in case of `Message Expired (507)` error - but only for those messages which
        ...
        /// <summary>
        ///     <para>
        ///         Timeout that is used to process message delivery for the contracts which ABI does not include "expire" header. If the message is not delivered within
        ///         the specified timeout the appropriate error occurs.
        ///     </para>
        ...
        ///     <para>
        ///         If client's device time is out of sync and difference is more than the threshold then error will occur. Also an error will occur if the specified
        ...
        /// <summary>
        ///     <para>
        ///         Maximum value for the endpoint's blockchain data syncronization latency (time-lag). Library periodically checks the current endpoint for blockchain
        ///         data syncronization latency. If the latency (time-lag) is less then `NetworkConfig.max_latency` then library selects another endpoint.
        ///     </para>
        ///     <para>Must be specified in milliseconds. Default is 60000 (1 min).</para>
        /// </summary>
