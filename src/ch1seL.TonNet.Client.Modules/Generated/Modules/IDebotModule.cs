...
namespace ch1seL.TonNet.Client.Modules
{
    public interface IDebotModule : ITonModule
    {
        ...
        /// </summary>
        public Task<RegisteredDebot> Start(object appObject, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        public Task<RegisteredDebot> Fetch(object appObject, CancellationToken cancellationToken = default);
