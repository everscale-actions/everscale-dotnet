...
namespace ch1seL.TonNet.Client.Modules
{
    public class CryptoModule : ICryptoModule
    {
        ...
        /// </summary>
        public async Task<RegisteredSigningBox> RegisterSigningBox(object appObject, CancellationToken cancellationToken = default)
        {
            return await _tonClientAdapter.Request<object, RegisteredSigningBox>("crypto.register_signing_box", appObject, cancellationToken);
        }
