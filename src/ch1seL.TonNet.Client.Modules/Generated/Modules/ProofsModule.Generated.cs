...
namespace ch1seL.TonNet.Client.Modules
{
    public class ProofsModule : IProofsModule
    {
        ...
        /// <para>For more information about proofs checking, see description of `proof_block_data` function.</para>
        /// </summary>
        public async Task ProofMessageData(ParamsOfProofMessageData @params, CancellationToken cancellationToken = default)
        {
            await _tonClientAdapter.Request<ParamsOfProofMessageData>("proofs.proof_message_data", @params, cancellationToken);
        }
    }
}