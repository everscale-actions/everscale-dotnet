...
namespace ch1seL.TonNet.Client.Modules
{
    public class DebotModule : IDebotModule
    {
        ...
        /// </summary>
        public async Task<RegisteredDebot> Start(object appObject, CancellationToken cancellationToken = default)
        {
            return await _tonClientAdapter.Request<object, RegisteredDebot>("debot.start", appObject, cancellationToken);
        }
        ...
        /// </summary>
        public async Task<RegisteredDebot> Fetch(object appObject, CancellationToken cancellationToken = default)
        {
            return await _tonClientAdapter.Request<object, RegisteredDebot>("debot.fetch", appObject, cancellationToken);
        }
