...
namespace ch1seL.TonNet.Client
{
    public interface IProcessingModule : ITonModule
    {
        ...
        /// </summary>
        public Task<ResultOfSendMessage> SendMessage(ParamsOfSendMessage @params, Action<ProcessingEvent> callback, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        public Task<ResultOfProcessMessage> WaitForTransaction(ParamsOfWaitForTransaction @params, Action<ProcessingEvent> callback, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        public Task<ResultOfProcessMessage> ProcessMessage(ParamsOfProcessMessage @params, Action<ProcessingEvent> request, CancellationToken cancellationToken = default);
    }
}