...
public class AbiModuleTests : IClassFixture<TonClientTestsFixture> {
	...
	public async Task AttachSignature() {
		string signature = await _tonClient.SignDetached(Keys, "KCGM36iTYuCYynk+Jnemis+mcwi3RFCke95i7l96s4Q=");
	...
	public async Task AttachSignature2() {
		string signature = await _tonClient.SignDetached(Keys, "i4Hs3PB12QA9UBFbOIpkG3JerHHqjm4LgvF4MA7TDsY=");
