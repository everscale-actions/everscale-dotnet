...
public class CryptoModuleTests : IClassFixture<EverClientTestsFixture>
{
    ...
    public async Task Factorize()
    {
        ...
        result.Factors[1].ShouldBe("53911073");
    }
    ...
    public async Task GenerateRandomSignKeys()
    {
        ...
        result.Secret.ShouldNotBe(result.Public);
    }
    ...
    public async Task NaclBoxKeypair()
    {
        ...
        result.Public.Length.ShouldBe(64);
        result.Secret.Length.ShouldBe(64);
        result.Public.ShouldNotBe(result.Secret);
    }
    ...
    private class MnemonicFromRandomData : IEnumerable<object[]>
    {
        ...
        {
            MnemonicDictionary?[] dict = Enum.GetValues(typeof(MnemonicDictionary)).Cast<MnemonicDictionary?>()
                .Append(null).ToArray();
